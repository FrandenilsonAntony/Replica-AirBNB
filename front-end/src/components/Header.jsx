    ...
    <header className="shadow-md">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-8">
        <Link to="/" className="flex items-center">
          <img
            className="h-20"
            src="https://static.thenounproject.com/png/1069770-200.png"
            alt="Logo Empresa"
          />
          <p className="text-primary-400 text-2xl font-bold">ManausAirBNB</p>
        </Link>
        ...
        >
          ...
          <p className="max-w-20 truncate sm:max-w-32">Antony Boarding</p>
        </Link>
      </div>
    </header>
  );
